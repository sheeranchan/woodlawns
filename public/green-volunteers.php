...
<html lang="en">
  <head>
    <title>Volunteers - The Woodlawns Centre</title>
    <meta charset="utf-8">
          ...
          <ul class="navbar-nav ml-auto pl-lg-5 pl-0">
            ...
            <li class="nav-item dropdown">
              ...
              <div class="dropdown-menu" aria-labelledby="dropdown02">
                ...
                <a class="dropdown-item active" href="green-volunteers.php">Become Our Volunteers</a>
              </div>
            </li>
            <li class="nav-item dropdown">
  ...
  <!-- END header -->
    ...
    <section class="home-slider inner-page owl-carousel">
      <div class="slider-item " style="background-image: url('img/subpage/header/volunteers_headers.jpg');">
              ...
              <div class="col-md-12 order-1 main mb-5">
                  <div class="row">
                      <div class="col-md-12 text-black">
                          <h2 class="theme-colour">Become Our Volunteers</h2>
                          <hr>
                          <form id="contactform" class="rounded" method="post" action="#">
                              ...
                              <div class="form-group field">
                                  <input type="submit" name="Submitted"  class="btn btn-primary margin-btm-5 float-right" value="Send Application" style="margin-left: 525px; margin-top: 5px;" />
                              </div>
                          </form>
                      </div>
                  </div>
