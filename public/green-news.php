...
<html lang="en">
  <head>
    <title>News - The Woodlawns Centre</title>
    <meta charset="utf-8">
          ...
          <div class="container">
              ...
              <div class="collapse navbar-collapse" id="navbarsExample05">
                  <ul class="navbar-nav ml-auto pl-lg-5 pl-0">
                      ...
                      <li class="nav-item">
                          <a class="nav-link active" href="green-news.php">News</a>
                      </li>
                      <li class="nav-item">
  ...
  <!-- END header -->
    ...
    <section class="home-slider inner-page owl-carousel">
      <div class="slider-item " style="background-image: url('img/subpage/header/news_header.jpg');">
          ...
          <div class="col-md-12 order-1 main mb-5">
            <div class="row">
              <div class="col-md-12 text-black">
                ...
                <h2 class="theme-colour">News Two: Title Two</h2>
                <hr>
                <p>(Dummy Data):Molestias nesciunt sequi dignissimos, illo laboriosam deserunt. Mollitia distinctio at ipsam expedita, quo explicabo impedit optio! Et quam at impedit, fugiat. Repudiandae dolore, nemo saepe molestiae optio earum ratione a ipsum voluptatum. Nam et aperiam consequatur odit laudantium labore itaque nihil veritatis repellat distinctio officiis quod pariatur possimus facilis quia, eum, voluptas sint quasi dignissimos aliquid illum a dicta optio.</p>
                <p class="element-animate" data-animate-effect="fadeIn"><img src="http://via.placeholder.com/750x350" alt="Image placeholder" class="img-fluid"></p>
                <p>(Dummy Data):Molestias nesciunt sequi dignissimos, illo laboriosam deserunt. Mollitia distinctio at ipsam expedita, quo explicabo impedit optio! Et quam at impedit, fugiat. Repudiandae dolore, nemo saepe molestiae optio earum ratione a ipsum voluptatum. Nam et aperiam consequatur odit laudantium labore itaque nihil veritatis repellat distinctio officiis quod pariatur possimus facilis quia, eum, voluptas sint quasi dignissimos aliquid illum a dicta optio.</p>
