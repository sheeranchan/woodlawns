...
$toaddress = "woodlawns@hotmail.co.uk";  //Change this to the email address you will be receiving your notices.
//$toaddress = "rcwo@compuserve.com";  //Change this to the email address you will be receiving your notices.
$mailhost = "smtp.gmail.com";  //Change this to your actual Domain name.
$fromaddress = "msgfromyourwebsite@gmail.com";  //Change this to the email address you will use to send and authenticate with.
$frompwd = "-snackSunday-";  //Change this to the above email addresses password.
$subject = "Message from Contact Form on The Woodlawns Centre website";  //Change this to your own email message subject.
