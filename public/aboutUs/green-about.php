...
<html lang="en">
  <head>
    <title>About Us - The Woodlawns Centre</title>
    <meta charset="utf-8">
                  ...
                  <ul class="navbar-nav ml-auto pl-lg-5 pl-0">
                      ...
                      <li class="nav-item dropdown">
                          ...
                          <div class="dropdown-menu" aria-labelledby="dropdown03">
                              <a class="dropdown-item active" href="green-about.php">About Woodlawns</a>
            ...
            <div class="col-md-7 col-sm-12 element-animate">
              ...
              <nav aria-label="breadcrumb">
                <ol class="breadcrumb breadcrumb-custom">
                  ...
                  <li class="breadcrumb-item active" aria-current="page">About Woodlawns</li>
                </ol>
              </nav>
            </div>
          </div>
        ...
        <div class="row">
          <div class="col-md-4 order-2 sidebar">
            ...
            <div class="sidebar-box">
              ...
              <ul class="list-unstyled sidelink">
                <li class="active"><a href="green-about.php">About Woodlawns</a></li>
                ...
                <li><a href="green-biography.php">Cheryl Biography</a></li>
                <li><a href="green-team.php">Who We Are</a></li>
                <li><a href="green-supporters.php">Supporters</a></li>
                <li><a href="green-partners.php">Partners</a></li>
          ...
          <div class="col-md-8 order-1 main mb-5">
            <div class="row">
              ...
              <div class="col-md-12">
                <h2 class="theme-colour">About Woodlawns</h2>
                <hr>
                <p class="text-black bigger-font-size">We are the only independently run older people’s day centre in the London Borough of Lambeth. The centre is also home several charities including the Lambeth Asian Centre and Make A Difference Black Afro-Caribbean Group and Lambeth Carers.</p>
                <p class="element-animate" data-animate-effect="fadeIn"><img src="../img/index/welcome_woodlawns.jpg" alt="Image placeholder" class="img-fluid"></p>
                <p>More text your want to put here</p>
